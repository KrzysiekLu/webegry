...
(0, _faqJs.faq)();
sectionContainer && (0, _projectsJs.projectObserver)(sectionContainer);
...
},{"./navbar.js":"iVcNQ","./faq.js":"2w2EV","./projects.js":"kSckf"}],"iVcNQ":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kSckf":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "projectObserver", ()=>projectObserver);
const projectObserver = (elementToObserve)=>{
    ...
    const removeFilter = (entries)=>{
        entries[0].isIntersecting ? entries[0].target.classList.add("project__img-filter--clear") : entries[0].target.classList.remove("project__img-filter--clear");
    };
    ...
    const resizeObserver = new ResizeObserver((elements, observer)=>{
        elements[0].contentRect.width < 850 ? projectsMiniatures.forEach((miniature)=>{
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["h1avV","f4tk1"], "f4tk1", "parcelRequireca99")

//# sourceMappingURL=index.04528a29.js.map
